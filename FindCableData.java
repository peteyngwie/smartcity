...
public class FindCableData extends AppCompatActivity implements TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_cable_data);
        ...
        if (true) {
            ...
            ArrayAdapter<String> idcnameadapter = new ArrayAdapter<String>(FindCableData.this, android.R.layout.simple_dropdown_item_1line, GetidcRoomListdataItem());
        ...
        if(true) {
            ...
            // 設定光纜名稱下拉式選單項目 //////////////////////////////////
            ArrayAdapter<String> cablenameadapter = new ArrayAdapter<String>(FindCableData.this, android.R.layout.simple_dropdown_item_1line, GetrfidCableNameListdataItem());
            Log.d(TAG,"光纜名稱1") ;
        ...
        if (true) {
            ...
            // 設定埠號下拉選單項目  /////////////////////////////////////
            ArrayAdapter<String> portnoadapter = new ArrayAdapter<String>(FindCableData.this, android.R.layout.simple_dropdown_item_1line, GetrfidPortNoListdataItem());
        ...
        if (true) {
            ...
            // 設定裝置名稱下拉選單項目  /////////////////////////////////////
            ArrayAdapter<String> devicenameadapter = new ArrayAdapter<String>(FindCableData.this, android.R.layout.simple_dropdown_item_1line, GetrfidDeviceNameListdataItem());
            ...
            atv_content.setValidator(new AutoCompleteTextView.Validator() {
                ...
                public boolean isValid(CharSequence text) {
                    ...
                    if (Arrays.binarySearch(idcRoomListdata, text.toString()) > 0) {
                        ...
                        Toast.makeText(FindCableData.this, "Correct", LENGTH_SHORT).show();
                        return true;
                    }
                    return false;
                }
        ...
        devicename_autocompletetext.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (hasFocus) {
                    ...
                    if (false) {
                        // For debugging !
                        for (int j = 0; j < rfidListDeviceNameFilter.length   ; j++)
                    ...
                    for ( int i = 0 ; i < rfidListDeviceNameFilter.length ; i ++)
                    {
                        ...
                        String devicename = rfidListDeviceNameFilter[i].toString() ;  // 取出裝置名稱
            ...
            public void afterTextChanged(Editable s) {
                ...
                for ( int i = 0 ; i < rfidListDeviceNameFilter.length ; i ++)
                {
                    ...
                    if (devicename_autocompletetext.toString().equals(rfiddeviceName) == true ) {
                        ...
                        String autotxt ;
                        autotxt = devicename_autocompletetext.toString() ;
                        Log.d(TAG,"auto text : " + autotxt.toString()) ;
...
//        assert this.FiberName != null ;
    ...
    private void SetrfidDeviceNameListdata(int amount)
    {
        ...
        Log.d(TAG,"SetrfidDeviceNameListdataSetrfidDeviceNameListdataSetrfidDeviceNameListdata " + Integer.toString(amount));
    ...
    private String GetrfidDeviceNameListdata(int index) {
        ...
        Log.d(TAG,"TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT");
         for (int i = 0 ; i < rfidListDeviceNameFilter.length ; i++) {
             Log.d(TAG,"INDEX  " + i + this.rfidListDeviceNameFilter[i]) ;
         }
        Log.d(TAG,"TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT");

        return this.rfidListDeviceNameFilter[index] ;    // 回傳 rfidListDeviceNameFilter 第i 個字串
    }
    ...
    private void ReadDataFromDB(SQLiteDatabase db , String table ) {
      ...
      boolean DEBUG = false ;
            ...
            handler.postDelayed(new Runnable(){
              ...
              //////////////////////////////////////////////////////////////////
              Log.d(TAG,"HHHHHHHHHHHHHHHHHHHHHHHHHH");
    ...
    private void AddListener () {
        ...
        BackPreviousimg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                db.close();
                Intent intent = new Intent(v.getContext(),FindCableWithOLDF.class) ;  // 回到纜線尋找( oldf ) 活動
                    ...
                    */
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                intent.setClass(FindCableData.this, /*SearchCableDatarfid.class*/
    ...
    public void DataSearchingPromptDialog(Context context ){
        ...
        dataSearchingPromptDialog = new ProgressDialog(FindCableData.this, R.style.dialog);
    ...
    private void SearchFieldsErrorDialog()
    {
        ...
        View alertCustomdialog = LayoutInflater.
                from(FindCableData.this).
                inflate(R.layout.errorfiledspromptdialog, null);

        //initialize alert builder.
        AlertDialog.Builder alert = new AlertDialog.Builder(FindCableData.this);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(event.getAction() == MotionEvent.ACTION_UP) {
            ...
            y2 = event.getY();
            if(y1 - y2 > 50) {
                Toast.makeText(FindCableData.this, "向上滑", Toast.LENGTH_SHORT).show();
            } else if(y2 - y1 > 50) {
                Toast.makeText(FindCableData.this, "向下滑", Toast.LENGTH_SHORT).show();
                Log.d(TAG,"下滑回到前一頁");
                finish();
                Intent intent = new Intent(this,MainSqaurefun.class);
                startActivity(intent);
            } else if(x1 - x2 > 50) {
                Toast.makeText(FindCableData.this, "向左滑", Toast.LENGTH_SHORT).show();
            } else if(x2 - x1 > 50) {
                Toast.makeText(FindCableData.this, "向右滑", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void onBackPressed(){
        ...
        Intent intent = new Intent(FindCableData.this , FindCableWithOLDF.class) ;
        startActivity(intent);
