...
public class CableDataWriting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statxt = (TextView)findViewById(R.id.statustxt);
        ...
        if (bundle != null) {
            ...
            setcablename(this.cablename);
            setfrom(this.from);
            setto(this.to);
            setfloor(this.floor);
            setidcroom(this.idcroom);
            setrow(this.row);
            setcabinet(this.cabinet);
            setbox(this.box);
            setport(this.port);
            setcomment(this.comment);
            setcablefirm(this.cablefirm);
            setequname(this.devicename);
            setbuildingfirm(this.buildingfirm);
            settransreciever(this.transmissionend);
            settransport(this.transmissionport);
            setupdater(this.updateuser);
            ...
            if (getstatus().equals("0"))
                ...
                statxt.setText(statxt.getText() + "未使用");
            else
                 // statusedit.setText(" 已使用");
                statxt.setText(statxt.getText() + "已使用");
        ...
        PreviousPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences pref = getSharedPreferences("backtobacktoSearchCableDatarfidforModification",MODE_PRIVATE);
                //讓pref處於編輯狀態
