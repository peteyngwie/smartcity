...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    Context context;
    public CustomAdapter(ArrayList<SearchCableDatarfidforModObj> modelList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(TAG,"YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYy");
                Log.d(TAG,"model f18 "  + model.getf18() );
                Log.d(TAG,"model f19 " + model.getf19() );
        ...
        holder.relativeLayout.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                // Toast.makeText(context, "長按第" + position + "個", Toast.LENGTH_SHORT).show();
                // do nothing !
                return false;
            }
        });
