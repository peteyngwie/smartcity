...
public class CustomerAdapterforCableFinding extends RecyclerView.Adapter<CustomerAdapterforCableFinding.MyViewHolder> {
    //create a list to pass our Model class
    ArrayList<SearchCableDatarfidforModObj> modelList;
    Context context;
    public CustomerAdapterforCableFinding (ArrayList<SearchCableDatarfidforModObj> modelList, Context context) {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable(){
                    ...
                    public void run() {
                        ...
                        //過兩秒後要做的事情 - 顯示查詢出來的資料內容

                        Intent i = new Intent();
                        i.setClass(v.getContext(), CableDataDetails.class);  // 顯示纜線資料
                        i.putExtras(bundle);

                        v.getContext().startActivity(i);
                        // ((Activity) context).finish();  // close its lay on activity
                        // ((Activity) context).getParent().overridePendingTransition(R.anim.activity_push_bottom_in, R.anim.activity_push_bottom_out);
                         ...
                         */
                              ...
                              //  ((Activity) context).getParent().overridePendingTransition(R.anim.activity_push_bottom_in, R.anim.activity_push_bottom_out);  // fade in/out  的特效
                        /*
                            }
                        });
...
}  // end of CustomerAdapterforCableFinding
